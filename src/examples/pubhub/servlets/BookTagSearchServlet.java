 ...
 */
@WebServlet("/SearchByBookTag")

public class BookTagSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("searchBookByBookTag.jsp").forward(request, response);
	}
}
