        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                	   <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Search by Book Tags<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                          <li>Popular tags</li>
                          <li><a href="AllBookTags">List all book tags</a></li>
                          <li><a href="AddBookTag">Add book tag</a></li>
                          <li><a href="RemoveBookTag">Remove book tag</a></li>
                          <li><a href="FindBooksByBookTag">Find books by book tag</a></li>
                        </ul>
                    </li>
					<li class="dropdown">
